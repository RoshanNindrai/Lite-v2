...
public protocol PluginType {
    ...
    func willParseResponse<P>(response: (Data?, URLResponse?, Error?), for Request: Request<P>) -> ServiceResponse
...
extension PluginType {
    ...
    public func willParseResponse<P>(response: (Data?, URLResponse?, Error?), for Request: Request<P>) -> ServiceResponse { return response }
}
